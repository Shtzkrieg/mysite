  ...
  try {
    ...
    const education = () => {
      try {
        ...
        console.error('Error accessing education data:', error);
        return [];
      }
    };
                    ...
                    <For each={education()}>
                      {(edu) => (
                        <div class="resume-item">
                          ...
                          <Show when={edu.courses?.length}>
                            <div class="courses-container">
                              <h4 class="courses-title">Relevant Courses:</h4>
                              <div class="skill-tags">
                                <For each={edu.courses}>
                                  {(course) => <span class="skill-tag">{course}</span>}
                                </For>
                              </div>
                            </div>
                          </Show>
    ...
    return <div>Error loading resume data. Check console for details.</div>;
  }
};
